      ...
      <div class="right-panel" @click="isLangMenuOpen = false">
        <div class="form-container">
          ...
          <form @submit.prevent="login" class="login-form" novalidate>
            ...
            <!-- Message d'erreur -->
            <transition name="error-slide">
              <p v-if="showError" class="error-message admin-error">
                <span class="error-dot"></span>
                {{ t.serverError }}
              </p>
            </transition>
...
const translations = {
  fr: {
    title: 'Espace Administrateur Veyra ®',
    description:
      "Connectez-vous avec vos identifiants administrateur pour accéder au tableau de bord de gestion Veyra.",
    question: 'Retour au site ? ',
    userLogin: 'Connexion utilisateur',
    email: 'Email',
    emailPlaceholder: 'admin@admin.com',
    ...
    serverError: 'Identifiants invalides ou accès non autorisé'
  },
  en: {
    title: 'Veyra ® Administrator Space',
    description:
      'Log in with your administrator credentials to access the Veyra management dashboard.',
    question: 'Back to site? ',
    ...
    serverError: 'Invalid credentials or unauthorized access'
  }
}
