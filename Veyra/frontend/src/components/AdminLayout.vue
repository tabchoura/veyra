  ...
  <div class="admin-wrapper">
    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <nav class="sidebar-nav">
        <button @click="$router.push('/admin')" :class="['nav-item', { active: $route.path === '/admin' }]">
        ...
        <button @click="$router.push('/users')" :class="['nav-item', { active: $route.path === '/users' }]">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button @click="$router.push('/admin/passports')" :class="['nav-item', { active: $route.path === '/admin/passports' }]">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button @click="$router.push('/admin/audit')" :class="['nav-item', { active: $route.path === '/admin/audit' }]">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
            <polyline points="14 2 14 8 20 8"></polyline>
        ...
        <button @click="$router.push('/admin/settings')" :class="['nav-item', { active: $route.path === '/admin/settings' }]">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
const props = defineProps({
  pageTitle: {
    type: String,
    default: 'Dashboard Administrateur'
  },
  pageSubtitle: {
    type: String,
...
.admin-wrapper{
  min-height: 100vh;
  background: #f6f9ff;            /* fond clair bleuté */
